...
module PlutusCore.Default.Builtins
    ( Tagged (..) -- need to export for coercible
    , DefaultFun (..)
    , DefaultFunVersion (..)
    , V1DefaultFun
    , V2DefaultFun
...
type V1DefaultFun = Tagged 'DefaultFunV1 DefaultFun
type V2DefaultFun = Tagged 'DefaultFunV2 DefaultFun
type VCurrentDefaultFun = V1DefaultFun

-- bypasses the tag for Flat,Pretty,Hashable.
-- may change in the future e.g. for flat
deriving newtype instance Flat a => Flat (Tagged (s :: DefaultFunVersion) a)
deriving newtype instance Pretty a => Pretty (Tagged (s :: DefaultFunVersion) a)
deriving newtype instance Hashable a => Hashable (Tagged (s :: DefaultFunVersion) a)
