...
compileBind :: GHC.CoreBind -> PluginM PLC.DefaultUni PLC.VCurrentDefaultFun GHC.CoreBind
compileBind = \case
...
compileMarkedExprs :: GHC.CoreExpr -> PluginM PLC.DefaultUni PLC.VCurrentDefaultFun GHC.CoreExpr
...
compileMarkedExprOrDefer :: String -> GHC.Type -> GHC.CoreExpr -> PluginM PLC.DefaultUni PLC.VCurrentDefaultFun GHC.CoreExpr
...
compileMarkedExpr :: String -> GHC.Type -> GHC.CoreExpr -> PluginM PLC.DefaultUni PLC.VCurrentDefaultFun GHC.CoreExpr
...
runCompiler
    :: forall uni fun m . (uni ~ PLC.DefaultUni, fun ~ PLC.VCurrentDefaultFun, MonadReader (CompileContext uni fun) m, MonadWriter CoverageIndex m, MonadQuote m, MonadError (CompileError uni fun) m, MonadIO m)
    => String
    -> PluginOptions
    -> GHC.CoreExpr
